...
_SONG_BG_PROMPT = (
    ...
    "YouTube segment's K-pop-style concert-stage opening theme song.\n\n"
    "This week's AI news theme for subtle inspiration:\n{topic}\n\n"
    "{lyrics_context}\n"
    "Depict an energetic K-pop concert / stage-live atmosphere: a dark navy base, sweeping "
    "neon spotlights, large LED stage screens, glowing music notes drifting in the air, "
    "laser beams, light-particle confetti, and futuristic tech accents (glowing circuit "
    "trails, holographic panels) that hint at the AI news theme above without depicting "
    "any literal news scene.\n\n"
